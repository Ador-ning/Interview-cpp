...
namespace http {
	...
	public:
		...
		public:
			...
			void set_max_age(int seconds) { max_age_ = seconds; }

			bool http_only() const { return http_only_; }

			void set_http_only(bool newVal) { http_only_ = newVal; }
			...
			void set_path(std::string const &d) { path_ = d; }

			bool secure() const { return secure_; }

			void set_secure(bool b) { secure_ = b; }
		...
		class context_t {
		public:
			context_t(request const &req) : req_(req) {}
			...
			bool has_cookies(const std::string &key) const {
